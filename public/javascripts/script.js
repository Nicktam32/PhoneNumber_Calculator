function generateTable() {
  ...
  const numberMessages = {
    ...
    "2": " 2：坤卦，陰土，老婦，㒼塞固執、有耐性、包容(坤主收藏)、慢性病(翻土帶病菌)、身體：婦科病、脾、胃、腹部、皮膚",
    "3": " 3：震卦，陽木，長男，口舌是非(3)、急進易燥(震)、聲音響面大(雷)、好爭鬥、拿住口面(木)、身體：筋骨、腰、手腳、車禍(指南車剋三碧蚩尤)、肝病",
    "4": " 4：巽卦，陰木，長女，文人書生(木)、理論型(木)、無框架多變感覺流(風)、好美、外貌主義、重名、漠視錢財、身體：股部、乳、膽、氣管(鼻敏感、哮喘)",
    "5": " 5：中宮無卦，土，皇帝，掌管威祟、災禍、做事不思後果、喜做調停者所有事都要經他手、身體：毒素、肚、腹、皮膚",
    "6": " 6：乾卦，陽金，老父，驛馬變動、做首領(乾)、一切都要被掌握(乾)、階級觀念重(乾)、不懼困難(金)、身體：頭、骨、肺、胃",
    "7": " 7：兌卦，陰金，少女，口舌挑撥是非(7)、盜賊破壞、兩舌不停、攬炒心態、身體：唇、口、喉、齒、舌、肺",
    "8": " 8：艮卦，陽土，少男，正財、財富、緩止(止)、累積的財富與功名、身體：手指、手背部、鼻、筋絡、 腎、腰背、背脊",
    "9": " 9：離卦，陰火，中女，開心樂觀(火)、追求虛幻(離中虛)、喜做指導者(明燈)、疑心重(燭火)、身體：血、心臟、目、小腸、 神經系統",
