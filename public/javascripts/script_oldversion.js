...
window.addEventListener('DOMContentLoaded', () => {
  ...
  phoneNumberInput.addEventListener('input', () => {
      ...
      for (let i = 0; i < lastEightDigits.length; i++) {
          const digit = parseInt(lastEightDigits[i]);
          if (i === 2 && digit === 0) {
              qimenRemarks += "● 宮位為做事的平台，也等於身處的客觀環境，宮位逢空亡，代表做事缺乏資源，能力難以發揮，或欠缺可以發揮表現的平台、媒介，使不上力、懷才不遇，比人家付出多、回收少、多勞少獲。容易居無定所離鄉背井。<br>";
          }
          if (i === 3 && digit === 0) {
              qimenRemarks += "● 八神代表人的思想觀念，「神」逢空亡，代表想法上較沒主見，「神」也代表神助、貴人，逢空亡，做事沒人幫、較無貴人，或沒祖蔭，一切得靠自己，白手起家。父母親身體不好。<br>";
          }
          if (i === 4 && digit === 0) {
              qimenRemarks += "● 九星代表人的個性、性格，「星」逢空亡，性格上較沒主見；「星」也代表發展，逢空亡，做事較無大的發展性，或是沒發展、或時機不對。管不住伴侶，影響伴侶運勢，容易單身。<br>";
          }
          if (i === 5 && digit === 0) {
              qimenRemarks += "● 八門代表人的心態或行動，「門」逢空亡，做事時心態或行動上較不積極，往往沒有、或找不到正確的做事方法或途徑，辦事常徒勞無功。容易恍神，說錯話，做錯決定。<br>";
          }
          if (i === 7 && digit === 0) {
              qimenRemarks += "● 倒數第二碼 0 為人生迷茫，沒有目標。<br>";
          }
          if (i === 8 && digit === 0) {
              qimenRemarks += "● 倒數最末碼 0 為四大皆空，加速人生歸零的速度。<br>";
          }
